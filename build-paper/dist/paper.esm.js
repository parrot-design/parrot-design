...
var InternalPaper = function (props, ref) {
    ...
    return (React.createElement(PaperRoot, __assign({}, restProps, { ref: ref, children: children, className: classNames(className, prefixCls, (_a = {},
            _a[prefixCls + "-elevation" + elevation] = hasValue(elevation),
            _a[prefixCls + "-round"] = !square,
            _a)) })));
};
var Paper = React.forwardRef(InternalPaper);
